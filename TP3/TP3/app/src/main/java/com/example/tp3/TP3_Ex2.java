...
public class TP3_Ex2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t_p3__ex2);
        ...
        findViewById(R.id.btnSubmit).setOnClickListener(v -> {
            if(!user_id.isEmpty()){
                ...
                Toast.makeText(getApplicationContext(), R.string.impossible_action, Toast.LENGTH_LONG).show();
            }
        });
    }
